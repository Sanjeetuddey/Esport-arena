...
// import bg from "../assets/dash.webp";
// import bg1 from "../assets/dash2.webp";
// import bg2 from "../assets/dash3.webp";
...
const Home = () => {
  return (
    <>
      ...
      >
        <div className="bg-black bg-opacity-70 p-8 rounded-2xl text-center max-w-3xl backdrop-blur-md">
          <h1 className="text-5xl md:text-6xl font-extrabold tracking-wide drop-shadow-lg">
            Enter The Esports Arena
          </h1>
          <p className="text-lg mt-4 opacity-90">
      ...
      {/* Categories */}
      <section className="px-6 md:px-16 py-12 bg-black text-white">
        <h2 className="text-3xl font-semibold mb-6">Popular Esports Categories</h2>
        <div className="grid md:grid-cols-4 gap-6">
          {[
            { name: "Valorant", icon: <FaGamepad /> },
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[bg1, bg2, bg].map((img, index) => (
            ...
            >
              ...
              />
              <div className="p-5">
                <h3 className="text-xl font-bold">Valorant Showdown {index + 1}</h3>
                <p className="text-gray-600 text-sm mt-1">Dec 15, 2025 · Online Event</p>
                <button className="mt-4 w-full bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 transition">
                  Register Now
                </button>
